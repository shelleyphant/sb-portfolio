...
thumbnail: ../images/massacreinmelbourne.png
techstack:
    - PHP
    - JavaScript
    - CSS
details:
    - - map
      - Google Maps
      - Custom routes and map overlays
    - - code
      - Custom Built
      - Entirely custom PHP and JS to create seamless navigations
---
...
Although created as a university project, Massacre in Melbourne works as a functional (if fictional) tour, and can be taken by visiting the application archive at [shelleyphant.com](https://www.shelleyphant.com/bonus-content/massacre-in-melbourne). There are two archives, the initial concept and an in-progress development product. Choose _development_ and _skip sign in_ for a more polished experience.
...
<ProjectInsights>
    I'm still proud of this project. There's now a lot I would change about the
    design and structure of the site, but this was the first time I developed
    something that _worked_, beyond just a static web page.
</ProjectInsights>
